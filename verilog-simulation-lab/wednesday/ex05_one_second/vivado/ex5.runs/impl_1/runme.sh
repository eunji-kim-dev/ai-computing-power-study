...
HD_PWD='C:/Users/kccistc/Downloads/inha/wednesday/ex05_one_second/vivado/ex5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log one_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source one_led.tcl -notrace
