...
HD_PWD='C:/Users/kccistc/Downloads/inha/wednesday/ex05_one_second/vivado/ex5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log one_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source one_led.tcl
