...
HD_PWD='C:/Users/kccistc/Downloads/inha/wednesday/ex03_fnd_one/vivado1/ex03.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fnd_dynammic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fnd_dynammic.tcl
