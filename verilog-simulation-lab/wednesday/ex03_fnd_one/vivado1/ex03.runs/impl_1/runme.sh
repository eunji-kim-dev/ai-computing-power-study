...
HD_PWD='C:/Users/kccistc/Downloads/inha/wednesday/ex03_fnd_one/vivado1/ex03.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fnd_dynammic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fnd_dynammic.tcl -notrace
