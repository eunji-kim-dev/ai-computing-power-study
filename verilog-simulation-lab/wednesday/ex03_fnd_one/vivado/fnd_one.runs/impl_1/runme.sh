...
HD_PWD='D:/verilog/inha/day03/ex03_fnd_one/vivado/fnd_one.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fnd_one.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fnd_one.tcl -notrace
