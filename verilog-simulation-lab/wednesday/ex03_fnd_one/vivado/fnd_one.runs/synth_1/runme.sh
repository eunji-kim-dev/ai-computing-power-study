...
HD_PWD='D:/verilog/inha/day03/ex03_fnd_one/vivado/fnd_one.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fnd_one.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fnd_one.tcl
