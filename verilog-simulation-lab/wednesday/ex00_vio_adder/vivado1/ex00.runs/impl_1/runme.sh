...
HD_PWD='C:/Users/kccistc/Downloads/inha/wednesday/ex00_vio_adder/vivado1/ex00.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder32_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder32_top.tcl -notrace
