...
HD_PWD='C:/Users/kccistc/Downloads/inha/wednesday/ex00_vio_adder/vivado1/ex00.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder32_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder32_top.tcl
