...
HD_PWD='C:/Users/kccistc/Downloads/inha/wednesday/ec06_Ultrasonic/vivado/ex06.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hcsr04_driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hcsr04_driver.tcl -notrace
