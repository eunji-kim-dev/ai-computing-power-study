...
HD_PWD='C:/Users/kccistc/Downloads/inha/wednesday/ec06_Ultrasonic/vivado/ex06.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hcsr04_driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hcsr04_driver.tcl
