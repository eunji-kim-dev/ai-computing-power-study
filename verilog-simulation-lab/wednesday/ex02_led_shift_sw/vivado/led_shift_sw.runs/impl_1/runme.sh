...
HD_PWD='D:/verilog/inha/day03/ex02_led_shift_sw/vivado/led_shift_sw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_shift_sw.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_shift_sw.tcl -notrace
