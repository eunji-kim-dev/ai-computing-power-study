...
HD_PWD='D:/verilog/inha/day03/ex02_led_shift_sw/vivado/led_shift_sw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_shift_sw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_shift_sw.tcl
