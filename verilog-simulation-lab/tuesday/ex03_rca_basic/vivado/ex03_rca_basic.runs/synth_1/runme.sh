...
HD_PWD='D:/verilog/inha/day01/ex03_rca_basic/vivado/ex03_rca_basic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rca_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rca_top.tcl
