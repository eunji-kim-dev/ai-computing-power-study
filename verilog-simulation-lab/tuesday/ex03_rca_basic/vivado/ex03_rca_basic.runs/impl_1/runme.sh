...
HD_PWD='D:/verilog/inha/day01/ex03_rca_basic/vivado/ex03_rca_basic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rca_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rca_top.tcl -notrace
