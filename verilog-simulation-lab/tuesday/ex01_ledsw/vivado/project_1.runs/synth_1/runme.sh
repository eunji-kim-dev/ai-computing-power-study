...
HD_PWD='C:/Users/kccistc/Downloads/inha/tuesday/ex01_ledsw/vivado/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_sw_led_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source logic_sw_led_top.tcl
