...
HD_PWD='C:/Users/kccistc/Downloads/inha/tuesday/ex01_ledsw/vivado/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_sw_led_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source logic_sw_led_top.tcl -notrace
