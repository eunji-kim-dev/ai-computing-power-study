...
HD_PWD='D:/verilog/inha/day03/01_vga_colorbar/vivado/01_vga_colorbar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_colorbar_1080p_basys3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_colorbar_1080p_basys3.tcl
