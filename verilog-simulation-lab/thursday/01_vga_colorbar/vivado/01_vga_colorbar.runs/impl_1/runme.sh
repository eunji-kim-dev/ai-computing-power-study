...
HD_PWD='D:/verilog/inha/day03/01_vga_colorbar/vivado/01_vga_colorbar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_colorbar_1080p_basys3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_colorbar_1080p_basys3.tcl -notrace
