...
#
# Script generated by Vivado on Sat Jan 03 23:29:09 +0900 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/verilog/20260103/03_sine_wave/vivado/03_sine_wave.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
