...
HD_PWD='D:/verilog/20260103/03_sine_wave/vivado/03_sine_wave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex03.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex03.tcl
