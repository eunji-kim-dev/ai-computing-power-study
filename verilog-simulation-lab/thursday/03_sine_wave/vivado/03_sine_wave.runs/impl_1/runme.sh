...
HD_PWD='D:/verilog/20260103/03_sine_wave/vivado/03_sine_wave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex03.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ex03.tcl -notrace
