...
HD_PWD='D:/verilog/20260103/05_vga_pic/vivado/05_vga_pic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_image_1080p_basys3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_image_1080p_basys3.tcl -notrace
