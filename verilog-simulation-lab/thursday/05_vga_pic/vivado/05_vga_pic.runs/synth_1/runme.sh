...
HD_PWD='D:/verilog/20260103/05_vga_pic/vivado/05_vga_pic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_image_1080p_basys3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_image_1080p_basys3.tcl
