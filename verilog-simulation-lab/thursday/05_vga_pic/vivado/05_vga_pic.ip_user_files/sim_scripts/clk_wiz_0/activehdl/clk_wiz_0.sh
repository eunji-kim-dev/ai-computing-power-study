...
#
# Script generated by Vivado on Sun Jan 04 19:58:10 +0900 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/verilog/20260103/01_vga_colorbar/vivado/01_vga_colorbar.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
