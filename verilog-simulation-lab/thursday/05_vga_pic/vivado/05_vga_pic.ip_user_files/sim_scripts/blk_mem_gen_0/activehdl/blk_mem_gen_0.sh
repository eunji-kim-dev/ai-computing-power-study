...
#
# Script generated by Vivado on Sun Jan 04 20:15:38 +0900 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/verilog/20260103/05_vga_pic/vivado/05_vga_pic.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
