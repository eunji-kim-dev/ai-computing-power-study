...
HD_PWD='D:/verilog/20260103/06_adc_uart/vivado/06_adc_uart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ex06_adc_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ex06_adc_uart.tcl
