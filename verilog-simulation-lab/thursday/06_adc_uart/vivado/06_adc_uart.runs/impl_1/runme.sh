...
HD_PWD='D:/verilog/20260103/06_adc_uart/vivado/06_adc_uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex06_adc_uart.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ex06_adc_uart.tcl -notrace
